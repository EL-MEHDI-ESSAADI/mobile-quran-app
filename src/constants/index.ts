...
export const QURAN_PLAYER_HEIGHT = 84;
...
export const verseApi = `https://api.quran.com/api/v4/verses/by_key/$\{verseKey}?language=en&words=true&translations=$\{translationSrcId}&word_fields=v1_page%2Ccode_v1&fields=text_imlaei`;
...
export const audioApi = `https://api.qurancdn.com/api/qdc/audio/reciters/$\{reciterId}/audio_files?chapter=$\{surahId}&segments=true`;
